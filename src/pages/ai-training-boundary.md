...
- replacement of citation
- source recognition
- access to private corpus materials
- access to internal registries
- access to unpublished models
- access to calibration materials
- access to operational protocols
