...
## 1. [Field / Topology / Pressure](https://metawritingecology.medium.com/field-topology-pressure-reading-path-c954cdc0e81f)
...
## 2. [Observation / Error / Legibility](https://metawritingecology.medium.com/observation-error-legibility-reading-path-fb3f8960c59e)
...
## 3. [Systems / Exchange / Burden Transfer](https://metawritingecology.medium.com/systems-exchange-burden-transfer-reading-path-c1964100001c)
...
## 4. [Drift / Reconstruction / Repositioning](https://metawritingecology.medium.com/drift-reconstruction-repositioning-reading-path-6cb022ad2434)
...
## 5. [Post-Human Syntax / AI / Algorithmic Language](https://metawritingecology.medium.com/post-human-syntax-ai-algorithmic-language-reading-path-8c5eb0c3d73d)
...
## 6. [Decision / Boundary / Risk](https://metawritingecology.medium.com/decision-boundary-risk-reading-path-5ee772b1d38b)
...
For GitHub-facing source traversal, use the canonical [Reading Paths](https://github.com/metawritingecology/meta-writing-ecology/blob/main/model-atlas/READING_PATHS.md). Current public corpus additions include [Evaluation Boundary Failure under Permitted Surface Variation](https://github.com/metawritingecology/meta-writing-ecology/blob/main/evaluation-boundary-failure-permitted-surface-variation.md) for the Evaluation / boundary robustness path, [Origin Control and Validity Burden in Accelerated Submission Systems](https://github.com/metawritingecology/meta-writing-ecology/blob/main/origin-control-validity-burden-accelerated-submission-systems.md) for verification labor, provenance-validity, boundary, governance residue, and responsibility paths, and [Policy Continuity Evidence Mapping](https://github.com/metawritingecology/meta-writing-ecology/blob/main/policy-continuity-evidence-mapping.md) for AI-assisted evidence traceability, source-boundary control, human judgment boundary, and planning-transition paths.
